...
FanDjango's [V2.3.7 release](https://github.com/FanDjango/TPFanCtrl2/releases/tag/V2.3.7). When sufficient feedback is
received these may be incorporated into the main trunk here.

* V2.3.7 Added "Single Fan" mode for laptops that have, well, only a single fan
* V2.3.6 Added one more mode for "LidClosedMode"
* V2.3.5 Added a new paramter "LidClosedMode" for the .ini file.
