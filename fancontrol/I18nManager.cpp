...
void I18nManager::LoadTranslations() {
    ...
    en["OPT_BACKGROUND_SERVICE"] = "Run as Background Service";
    en["OPT_MINIMIZE_TRAY"] = "Minimize to Tray";
    en["OPT_MINIMIZE_CLOSE"] = "Close Button Minimizes";
    en["LBL_PIPELINE_STATUS"] = "Detection Pipeline";
    en["LBL_PIPELINE_OK"] = "Healthy";
    en["LBL_PIPELINE_WARN"] = "Needs Attention";
    en["LBL_AVAILABLE_SENSORS"] = "Available sensors";
    en["LBL_READ_ERRORS"] = "Read errors";
    ...
    zh["MODE_EC_AUTO"] = "EC \xE8\x87\xAA\xE5\x8A\xA8";
    ...
    zh["OPT_BACKGROUND_SERVICE"] = "后台服务模式";
    ...
    zh["LBL_PIPELINE_STATUS"] = "检测管线";
    zh["LBL_PIPELINE_OK"] = "正常";
    zh["LBL_PIPELINE_WARN"] = "需要关注";
    zh["LBL_AVAILABLE_SENSORS"] = "可用传感器";
    zh["LBL_READ_ERRORS"] = "读取错误";
    ...
    zh["LBL_FAN_MAX"] = "\xE6\x9C\x80\xE9\xAB\x98\xE6\x8C\xA1\xE4\xBD\x8D";
